...
void draw() {
  ...
  for (int i = 0; i < count; i++) {
    ...
    if (r[i].isInContactWith(q)) {      //check to see if the raindrop is in contact with the point represented by the PVector called mouse
